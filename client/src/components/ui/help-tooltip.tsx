    ...
    <TooltipProvider>
      <Tooltip delayDuration={300}>
        ...
        <TooltipContent 
          side={side} 
          align={align}
          className="max-w-[300px] whitespace-normal break-words font-manrope bg-white p-3 text-sm leading-snug text-gray-700 shadow-md rounded-md border border-gray-100"
          sideOffset={4}
        >
